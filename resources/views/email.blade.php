...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
  <head>
    ...
    <title>Pendaftaran Unair SOS</title>
    <!-- <style> -->
  </head>
  <body>
            ...
            <table align="center" class="container header float-center"><tbody><tr><td>
              <table class="row"><tbody><tr>
                <th class="small-12 large-12 columns first last"><table><tr><th>
                  <h1 class="text-center">Selamat datang di Unair SOS</h1>

                  <center data-parsed="">
                    <table align="center" class="menu text-center float-center"><tr><td><table><tr>
                      <th class="menu-item float-center"><a href="#">Home</a></th>
                      <th class="menu-item float-center"><a href="#">About</a></th>
                      <th class="menu-item float-center"><a href="#">Sign Up</a></th>
                      <th class="menu-item float-center"><a href="#">Login</a></th>
            ...
            <table align="center" class="container body-border float-center"><tbody><tr><td>
              <table class="row"><tbody><tr>
                <th class="small-12 large-12 columns first last"><table><tr><th>
                  ...
                  <h4>Tinggal satu langkah lagi untuk memverifikasi akun Unair SOS Anda. Silahkan klik link berikut untuk memverifikasi:</h4>
									<a href="localhost:8000/confirm?token={{$token}}"><b>localhost:8000/confirm?token={{$token}}</b></a>
                  <center data-parsed="">
                    <table align="center" class="menu float-center"><tr><td><table><tr>
                      <th class="menu-item float-center"><a href="#">unairsos.com</a></th>
                      <th class="menu-item float-center"><a href="#">Facebook</a></th>
                      <th class="menu-item float-center"><a href="#">Twitter</a></th>
                      <th class="menu-item float-center"><a href="#"> (031) 5915551</a></th>
                    </tr></table></td></tr></table>
                  </center>
